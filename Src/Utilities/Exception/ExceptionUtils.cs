...
namespace CXUtils.Common
{
	...
	public static class ExceptionUtils
	{
		...
		/// </summary>
		public static Exception NotAccessible => new(NOT_ACCESSIBLE);

		/// <summary>
		///     The memory here is not released.
		/// </summary>
		public static Exception MemoryNotReleased => new(NOT_RELEASED);

		/// <summary>
		///     The enum is not implemented.
		/// </summary>
		public static NotImplementedException EnumNotImplemented => new(ENUM_NOT_IMPLEMENTED);
		public static NotImplementedException PossibilityNotImplemented => new(POSSIBILITY_NOT_IMPLEMENTED);

		/// <summary>
		///     The value is invalid.
		/// </summary>
		public static Exception InvalidValue => new(VALUE_INVALID);

		public static Exception OutOfRange => new(VALUE_OUT_OF_RANGE);
		/// <summary>
		///     The value is out of range.
		/// </summary>
		public static Exception InvalidLength => new(VALUE_LENGTH_INVALID);
		public static Exception ElementEmpty => new(VALUE_ELEMENT_EMPTY);
		public static Exception LengthZero   => new(VALUE_LENGTH_ZERO);
