...
namespace CXUtils.Types
{
    ...
    public readonly struct Float3x3 : IEquatable<Float3x3>, IFormattable
    {
        ...
        public static Float3 operator *( Float3 vector, Float3x3 matrix ) => new Float3(
        ...
        public static Float3 operator *( Float3x3 matrix, Float3 matrix3x1 ) => new Float3(
        ...
        {
            using ( CommonPools.StringBuilder.Pop( out var sb ) )
            {
        ...
        public static Float3x3 BuildDiagonal( Float3 value ) => new Float3x3(
            new Float3( value.x ),
            new Float3( 0f, value.y ),
            new Float3( 0f, 0f, value.z )
        );

        public static Float3x3 BuildScalar( float value ) => new Float3x3(
            new Float3( value ),
            new Float3( 0f, value ),
